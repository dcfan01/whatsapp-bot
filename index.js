...
client.on('message', async msg => {
    ...
    let txt= msg.body.trim().toLowerCase();
    if(txt.includes('oreiro'))
        msg.reply('https://www.youtube.com/watch?v=Mz3YyiV6lVU');
    if(txt === '!introduccion')
        msg.reply('Beep beep boop! (¡Hola a todos! Soy R2-D2, un droide astromecánico aquí para ayudar. Actualmente, mi único comando habilitado es !ping, y responderé con un "pong" cuando lo utilicen. ¡Estoy listo para asistirlos en lo que necesiten! Beep boop!)')
